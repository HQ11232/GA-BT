...
class CanAccelerate(py_trees.behaviour.Behaviour):
    """Condition trigger leaf for ACT_ACCELERATE"""
...
class CanSwitchLeft(py_trees.behaviour.Behaviour):
    """Condition trigger leaf for ACT_SWITCHLEFT"""
...
class CanSwitchRight(py_trees.behaviour.Behaviour):
    """Condition trigger leaf for ACT_SWITCHRIGHT"""
...
class Accelerate(py_trees.behaviour.Behaviour):
    """Behavior leaf for ACT_ACCELERATE"""
...
class SwitchLeft(py_trees.behaviour.Behaviour):
    """Behavior leaf for ACT_SWITCHLEFT"""
...
class SwitchRight(py_trees.behaviour.Behaviour):
    """Behavior leaf for ACT_SWITCHRIGHT"""
...
def BasicBehaviorTree(name="Planner") -> py_trees.trees.BehaviourTree:
